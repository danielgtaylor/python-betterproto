...
class ExtensionRangeOptions(betterproto.Message):
    ...
    verification: "ExtensionRangeOptionsVerificationState" = betterproto.enum_field(3, enum_default_value=lambda: ExtensionRangeOptionsVerificationState.try_value(0))
    """
...
class FieldOptions(betterproto.Message):
    ...
    retention: "FieldOptionsOptionRetention" = betterproto.enum_field(17, enum_default_value=lambda: FieldOptionsOptionRetention.try_value(0))
    targets: List["FieldOptionsOptionTargetType"] = betterproto.enum_field(19, enum_default_value=lambda: FieldOptionsOptionTargetType.try_value(0))
...
class FeatureSet(betterproto.Message):
    ...
    field_presence: "FeatureSetFieldPresence" = betterproto.enum_field(1, enum_default_value=lambda: FeatureSetFieldPresence.try_value(0))
    enum_type: "FeatureSetEnumType" = betterproto.enum_field(2, enum_default_value=lambda: FeatureSetEnumType.try_value(0))
    ...
    utf8_validation: "FeatureSetUtf8Validation" = betterproto.enum_field(4, enum_default_value=lambda: FeatureSetUtf8Validation.try_value(0))
    message_encoding: "FeatureSetMessageEncoding" = betterproto.enum_field(5, enum_default_value=lambda: FeatureSetMessageEncoding.try_value(0))
    json_format: "FeatureSetJsonFormat" = betterproto.enum_field(6, enum_default_value=lambda: FeatureSetJsonFormat.try_value(0))
...
class GeneratedCodeInfoAnnotation(betterproto.Message):
    ...
    semantic: "GeneratedCodeInfoAnnotationSemantic" = betterproto.enum_field(5, enum_default_value=lambda: GeneratedCodeInfoAnnotationSemantic.try_value(0))
...
class Value(betterproto.Message):
    ...
    null_value: Optional["NullValue"] = betterproto.enum_field(
        1, enum_default_value=lambda: NullValue.try_value(0), optional=True, group="kind"
    )
