...
class FieldKind(bananaproto.Enum):
    """Basic field types."""
...
class FieldCardinality(bananaproto.Enum):
...
class FieldDescriptorProtoType(bananaproto.Enum):
    TYPE_DOUBLE = 1
...
class FieldDescriptorProtoLabel(bananaproto.Enum):
    LABEL_OPTIONAL = 1
...
class FileOptionsOptimizeMode(bananaproto.Enum):
...
class FieldOptionsCType(bananaproto.Enum):
    STRING = 0
    """Default mode."""
...
class FieldOptionsJsType(bananaproto.Enum):
    JS_NORMAL = 0
...
class MethodOptionsIdempotencyLevel(bananaproto.Enum):
    """
...
class NullValue(bananaproto.Enum):
    """
...
class Any(bananaproto.Message):
    ...
    type_url: str = bananaproto.string_field(1)
    """
    ...
    value: bytes = bananaproto.bytes_field(2)
    """
...
@dataclass(eq=False, repr=False)
class SourceContext(bananaproto.Message):
    """
    `SourceContext` represents information about the source of a protobuf
    element, like the file in which it is defined.
    """

    file_name: str = bananaproto.string_field(1)
    """
...
@dataclass(eq=False, repr=False)
class Type(bananaproto.Message):
    """A protocol buffer message type."""

    name: str = bananaproto.string_field(1)
    """The fully qualified message name."""

    fields: List["Field"] = bananaproto.message_field(2)
    """The list of fields."""

    oneofs: List[str] = bananaproto.string_field(3)
    """The list of types appearing in `oneof` definitions in this type."""

    options: List["Option"] = bananaproto.message_field(4)
    """The protocol buffer options."""

    source_context: "SourceContext" = bananaproto.message_field(5)
    """The source context."""

    syntax: "Syntax" = bananaproto.enum_field(6)
    """The source syntax."""


@dataclass(eq=False, repr=False)
class Field(bananaproto.Message):
    """A single field of a message type."""

    kind: "FieldKind" = bananaproto.enum_field(1)
    """The field type."""

    cardinality: "FieldCardinality" = bananaproto.enum_field(2)
    """The field cardinality."""

    number: int = bananaproto.int32_field(3)
    """The field number."""

    name: str = bananaproto.string_field(4)
    """The field name."""

    type_url: str = bananaproto.string_field(6)
    """
    The field type URL, without the scheme, for message or enumeration types.
    Example: `"type.googleapis.com/google.protobuf.Timestamp"`.
    """

    oneof_index: int = bananaproto.int32_field(7)
    """
    The index of the field type in `Type.oneofs`, for message or enumeration
    types. The first type has index 1; zero means the type is not in the list.
    """

    packed: bool = bananaproto.bool_field(8)
    """Whether to use alternative packed wire representation."""

    options: List["Option"] = bananaproto.message_field(9)
    """The protocol buffer options."""

    json_name: str = bananaproto.string_field(10)
    """The field JSON name."""

    default_value: str = bananaproto.string_field(11)
    """
...
@dataclass(eq=False, repr=False)
class Enum(bananaproto.Message):
    """Enum type definition."""

    name: str = bananaproto.string_field(1)
    """Enum type name."""

    enumvalue: List["EnumValue"] = bananaproto.message_field(
        2, wraps=bananaproto.TYPE_ENUM
    )
    """Enum value definitions."""

    options: List["Option"] = bananaproto.message_field(3)
    """Protocol buffer options."""

    source_context: "SourceContext" = bananaproto.message_field(4)
    """The source context."""

    syntax: "Syntax" = bananaproto.enum_field(5)
    """The source syntax."""


@dataclass(eq=False, repr=False)
class EnumValue(bananaproto.Message):
    """Enum value definition."""

    name: str = bananaproto.string_field(1)
    """Enum value name."""

    number: int = bananaproto.int32_field(2)
    """Enum value number."""
...
@dataclass(eq=False, repr=False)
class Option(bananaproto.Message):
    """
    ...
    value: "Any" = bananaproto.message_field(2)
    """
...
class Api(bananaproto.Message):
    ...
    methods: List["Method"] = bananaproto.message_field(2)
    """The methods of this interface, in unspecified order."""

    options: List["Option"] = bananaproto.message_field(3)
    """Any metadata attached to the interface."""

    version: str = bananaproto.string_field(4)
    """
    ...
    mixins: List["Mixin"] = bananaproto.message_field(6)
    """Included interfaces. See [Mixin][]."""

    syntax: "Syntax" = bananaproto.enum_field(7)
    """The source syntax of the service."""


@dataclass(eq=False, repr=False)
class Method(bananaproto.Message):
    """Method represents a method of an API interface."""

    name: str = bananaproto.string_field(1)
    """The simple name of this method."""

    request_type_url: str = bananaproto.string_field(2)
    """A URL of the input message type."""

    request_streaming: bool = bananaproto.bool_field(3)
    """If true, the request is streamed."""

    response_type_url: str = bananaproto.string_field(4)
    """The URL of the output message type."""

    response_streaming: bool = bananaproto.bool_field(5)
    """If true, the response is streamed."""

    options: List["Option"] = bananaproto.message_field(6)
...
@dataclass(eq=False, repr=False)
class Mixin(bananaproto.Message):
    """
    ...
    root: str = bananaproto.string_field(2)
    """
...
@dataclass(eq=False, repr=False)
class FileDescriptorSet(bananaproto.Message):
    """
    The protocol compiler can output a FileDescriptorSet containing the .proto
    files it parses.
    """

    file: List["FileDescriptorProto"] = bananaproto.message_field(1)


@dataclass(eq=False, repr=False)
class FileDescriptorProto(bananaproto.Message):
    """Describes a complete .proto file."""

    name: str = bananaproto.string_field(1)
    package: str = bananaproto.string_field(2)
    dependency: List[str] = bananaproto.string_field(3)
    """Names of files imported by this file."""

    public_dependency: List[int] = bananaproto.int32_field(10)
    """Indexes of the public imported files in the dependency list above."""

    weak_dependency: List[int] = bananaproto.int32_field(11)
    """
    Indexes of the weak imported files in the dependency list. For Google-
    internal migration only. Do not use.
    """

    message_type: List["DescriptorProto"] = bananaproto.message_field(4)
    """All top-level definitions in this file."""

    enum_type: List["EnumDescriptorProto"] = bananaproto.message_field(5)
    service: List["ServiceDescriptorProto"] = bananaproto.message_field(6)
    extension: List["FieldDescriptorProto"] = bananaproto.message_field(7)
    options: "FileOptions" = bananaproto.message_field(8)
    source_code_info: "SourceCodeInfo" = bananaproto.message_field(9)
    """
    ...
    syntax: str = bananaproto.string_field(12)
    """
...
@dataclass(eq=False, repr=False)
class DescriptorProto(bananaproto.Message):
    """Describes a message type."""

    name: str = bananaproto.string_field(1)
    field: List["FieldDescriptorProto"] = bananaproto.message_field(2)
    extension: List["FieldDescriptorProto"] = bananaproto.message_field(6)
    nested_type: List["DescriptorProto"] = bananaproto.message_field(3)
    enum_type: List["EnumDescriptorProto"] = bananaproto.message_field(4)
    extension_range: List["DescriptorProtoExtensionRange"] = bananaproto.message_field(
        5
    )
    oneof_decl: List["OneofDescriptorProto"] = bananaproto.message_field(8)
    options: "MessageOptions" = bananaproto.message_field(7)
    reserved_range: List["DescriptorProtoReservedRange"] = bananaproto.message_field(9)
    reserved_name: List[str] = bananaproto.string_field(10)
    """
...
@dataclass(eq=False, repr=False)
class DescriptorProtoExtensionRange(bananaproto.Message):
    start: int = bananaproto.int32_field(1)
    end: int = bananaproto.int32_field(2)
    options: "ExtensionRangeOptions" = bananaproto.message_field(3)


@dataclass(eq=False, repr=False)
class DescriptorProtoReservedRange(bananaproto.Message):
    """
...
@dataclass(eq=False, repr=False)
class ExtensionRangeOptions(bananaproto.Message):
    uninterpreted_option: List["UninterpretedOption"] = bananaproto.message_field(999)
    """The parser stores options it doesn't recognize here. See above."""


@dataclass(eq=False, repr=False)
class FieldDescriptorProto(bananaproto.Message):
    """Describes a field within a message."""

    name: str = bananaproto.string_field(1)
    number: int = bananaproto.int32_field(3)
    label: "FieldDescriptorProtoLabel" = bananaproto.enum_field(4)
    type: "FieldDescriptorProtoType" = bananaproto.enum_field(5)
    """
    ...
    type_name: str = bananaproto.string_field(6)
    """
    ...
    extendee: str = bananaproto.string_field(2)
    """
    For extensions, this is the name of the type being extended.  It is
    resolved in the same manner as type_name.
    """

    default_value: str = bananaproto.string_field(7)
    """
    ...
    oneof_index: int = bananaproto.int32_field(9)
    """
    ...
    options: "FieldOptions" = bananaproto.message_field(8)
    proto3_optional: bool = bananaproto.bool_field(17)
    """
...
@dataclass(eq=False, repr=False)
class OneofDescriptorProto(bananaproto.Message):
    """Describes a oneof."""

    name: str = bananaproto.string_field(1)
    options: "OneofOptions" = bananaproto.message_field(2)


@dataclass(eq=False, repr=False)
class EnumDescriptorProto(bananaproto.Message):
    """Describes an enum type."""

    name: str = bananaproto.string_field(1)
    value: List["EnumValueDescriptorProto"] = bananaproto.message_field(2)
    options: "EnumOptions" = bananaproto.message_field(3)
    reserved_range: List[
        "EnumDescriptorProtoEnumReservedRange"
    ] = bananaproto.message_field(4)
    """
    ...
    reserved_name: List[str] = bananaproto.string_field(5)
    """
...
@dataclass(eq=False, repr=False)
class EnumDescriptorProtoEnumReservedRange(bananaproto.Message):
    """
...
@dataclass(eq=False, repr=False)
class EnumValueDescriptorProto(bananaproto.Message):
    """Describes a value within an enum."""

    name: str = bananaproto.string_field(1)
    number: int = bananaproto.int32_field(2)
    options: "EnumValueOptions" = bananaproto.message_field(3)


@dataclass(eq=False, repr=False)
class ServiceDescriptorProto(bananaproto.Message):
    """Describes a service."""

    name: str = bananaproto.string_field(1)
    method: List["MethodDescriptorProto"] = bananaproto.message_field(2)
    options: "ServiceOptions" = bananaproto.message_field(3)


@dataclass(eq=False, repr=False)
class MethodDescriptorProto(bananaproto.Message):
    """Describes a method of a service."""

    name: str = bananaproto.string_field(1)
    input_type: str = bananaproto.string_field(2)
    """
    Input and output type names.  These are resolved in the same way as
    FieldDescriptorProto.type_name, but must refer to a message type.
    """

    output_type: str = bananaproto.string_field(3)
    options: "MethodOptions" = bananaproto.message_field(4)
    client_streaming: bool = bananaproto.bool_field(5)
    """Identifies if client streams multiple client messages"""

    server_streaming: bool = bananaproto.bool_field(6)
    """Identifies if server streams multiple server messages"""


@dataclass(eq=False, repr=False)
class FileOptions(bananaproto.Message):
    java_package: str = bananaproto.string_field(1)
    """
    ...
    java_outer_classname: str = bananaproto.string_field(8)
    """
    ...
    java_multiple_files: bool = bananaproto.bool_field(10)
    """
    ...
    java_generate_equals_and_hash: bool = bananaproto.bool_field(20)
    """This option does nothing."""

    java_string_check_utf8: bool = bananaproto.bool_field(27)
    """
    ...
    optimize_for: "FileOptionsOptimizeMode" = bananaproto.enum_field(9)
    go_package: str = bananaproto.string_field(11)
    """
    ...
    cc_generic_services: bool = bananaproto.bool_field(16)
    """
    ...
    java_generic_services: bool = bananaproto.bool_field(17)
    py_generic_services: bool = bananaproto.bool_field(18)
    php_generic_services: bool = bananaproto.bool_field(42)
    deprecated: bool = bananaproto.bool_field(23)
    """
    ...
    cc_enable_arenas: bool = bananaproto.bool_field(31)
    """
    Enables the use of arenas for the proto messages in this file. This applies
    only to generated classes for C++.
    """

    objc_class_prefix: str = bananaproto.string_field(36)
    """
    Sets the objective c class prefix which is prepended to all objective c
    generated classes from this .proto. There is no default.
    """

    csharp_namespace: str = bananaproto.string_field(37)
    """Namespace for generated classes; defaults to the package."""

    swift_prefix: str = bananaproto.string_field(39)
    """
    ...
    php_class_prefix: str = bananaproto.string_field(40)
    """
    Sets the php class prefix which is prepended to all php generated classes
    from this .proto. Default is empty.
    """

    php_namespace: str = bananaproto.string_field(41)
    """
    ...
    php_metadata_namespace: str = bananaproto.string_field(44)
    """
    ...
    ruby_package: str = bananaproto.string_field(45)
    """
...
@dataclass(eq=False, repr=False)
class MessageOptions(bananaproto.Message):
    message_set_wire_format: bool = bananaproto.bool_field(1)
    """
    ...
    no_standard_descriptor_accessor: bool = bananaproto.bool_field(2)
    """
    ...
    deprecated: bool = bananaproto.bool_field(3)
    """
    ...
    map_entry: bool = bananaproto.bool_field(7)
    """
...
@dataclass(eq=False, repr=False)
class FieldOptions(bananaproto.Message):
    ctype: "FieldOptionsCType" = bananaproto.enum_field(1)
    """
    ...
    packed: bool = bananaproto.bool_field(2)
    """
    ...
    jstype: "FieldOptionsJsType" = bananaproto.enum_field(6)
    """
    ...
    lazy: bool = bananaproto.bool_field(5)
    """
    ...
    unverified_lazy: bool = bananaproto.bool_field(15)
    """
    ...
    weak: bool = bananaproto.bool_field(10)
...
@dataclass(eq=False, repr=False)
class OneofOptions(bananaproto.Message):
    uninterpreted_option: List["UninterpretedOption"] = bananaproto.message_field(999)
    """The parser stores options it doesn't recognize here. See above."""


@dataclass(eq=False, repr=False)
class EnumOptions(bananaproto.Message):
    allow_alias: bool = bananaproto.bool_field(2)
    """
...
@dataclass(eq=False, repr=False)
class EnumValueOptions(bananaproto.Message):
    deprecated: bool = bananaproto.bool_field(1)
    """
...
@dataclass(eq=False, repr=False)
class ServiceOptions(bananaproto.Message):
    deprecated: bool = bananaproto.bool_field(33)
    """
...
@dataclass(eq=False, repr=False)
class MethodOptions(bananaproto.Message):
    deprecated: bool = bananaproto.bool_field(33)
    """
    ...
    idempotency_level: "MethodOptionsIdempotencyLevel" = bananaproto.enum_field(34)
    uninterpreted_option: List["UninterpretedOption"] = bananaproto.message_field(999)
    """The parser stores options it doesn't recognize here. See above."""


@dataclass(eq=False, repr=False)
class UninterpretedOption(bananaproto.Message):
    """
    ...
    name: List["UninterpretedOptionNamePart"] = bananaproto.message_field(2)
    identifier_value: str = bananaproto.string_field(3)
    """
    The value of the uninterpreted option, in whatever type the tokenizer
    identified it as during parsing. Exactly one of these should be set.
    """

    positive_int_value: int = bananaproto.uint64_field(4)
    negative_int_value: int = bananaproto.int64_field(5)
    double_value: float = bananaproto.double_field(6)
    string_value: bytes = bananaproto.bytes_field(7)
    aggregate_value: str = bananaproto.string_field(8)


@dataclass(eq=False, repr=False)
class UninterpretedOptionNamePart(bananaproto.Message):
    """
    ...
    name_part: str = bananaproto.string_field(1)
    is_extension: bool = bananaproto.bool_field(2)


@dataclass(eq=False, repr=False)
class SourceCodeInfo(bananaproto.Message):
    """
    Encapsulates information about the original source file from which a
    FileDescriptorProto was generated.
    """

    location: List["SourceCodeInfoLocation"] = bananaproto.message_field(1)
    """
...
@dataclass(eq=False, repr=False)
class SourceCodeInfoLocation(bananaproto.Message):
    path: List[int] = bananaproto.int32_field(1)
    """
    ...
    span: List[int] = bananaproto.int32_field(2)
    """
    ...
    leading_comments: str = bananaproto.string_field(3)
    """
    ...
    trailing_comments: str = bananaproto.string_field(4)
    leading_detached_comments: List[str] = bananaproto.string_field(6)


@dataclass(eq=False, repr=False)
class GeneratedCodeInfo(bananaproto.Message):
    """
    ...
    annotation: List["GeneratedCodeInfoAnnotation"] = bananaproto.message_field(1)
    """
...
@dataclass(eq=False, repr=False)
class GeneratedCodeInfoAnnotation(bananaproto.Message):
    path: List[int] = bananaproto.int32_field(1)
    """
    ...
    source_file: str = bananaproto.string_field(2)
    """Identifies the filesystem path to the original source .proto."""

    begin: int = bananaproto.int32_field(3)
    """
    Identifies the starting offset in bytes in the generated code that relates
    to the identified object.
    """

    end: int = bananaproto.int32_field(4)
    """
...
@dataclass(eq=False, repr=False)
class Duration(bananaproto.Message):
    """
    ...
    seconds: int = bananaproto.int64_field(1)
    """
    ...
    nanos: int = bananaproto.int32_field(2)
    """
...
@dataclass(eq=False, repr=False)
class FieldMask(bananaproto.Message):
    """
    ...
    paths: List[str] = bananaproto.string_field(1)
    """The set of field mask paths."""


@dataclass(eq=False, repr=False)
class Struct(bananaproto.Message):
    """
    ...
    fields: Dict[str, "Value"] = bananaproto.map_field(
        1, bananaproto.TYPE_STRING, bananaproto.TYPE_MESSAGE
    )
    """Unordered map of dynamically typed values."""


@dataclass(eq=False, repr=False)
class Value(bananaproto.Message):
    """
    ...
    null_value: "NullValue" = bananaproto.enum_field(1, group="kind")
    """Represents a null value."""

    number_value: float = bananaproto.double_field(2, group="kind")
    """Represents a double value."""

    string_value: str = bananaproto.string_field(3, group="kind")
    """Represents a string value."""

    bool_value: bool = bananaproto.bool_field(4, group="kind")
    """Represents a boolean value."""

    struct_value: "Struct" = bananaproto.message_field(5, group="kind")
    """Represents a structured value."""

    list_value: "ListValue" = bananaproto.message_field(6, group="kind")
    """Represents a repeated `Value`."""


@dataclass(eq=False, repr=False)
class ListValue(bananaproto.Message):
    """
    `ListValue` is a wrapper around a repeated field of values. The JSON
    representation for `ListValue` is JSON array.
    """

    values: List["Value"] = bananaproto.message_field(1)
    """Repeated field of dynamically typed values."""


@dataclass(eq=False, repr=False)
class Timestamp(bananaproto.Message):
    """
...
@dataclass(eq=False, repr=False)
class DoubleValue(bananaproto.Message):
    """
    Wrapper message for `double`. The JSON representation for `DoubleValue` is
    JSON number.
    """

    value: float = bananaproto.double_field(1)
    """The double value."""


@dataclass(eq=False, repr=False)
class FloatValue(bananaproto.Message):
    """
    Wrapper message for `float`. The JSON representation for `FloatValue` is
    JSON number.
    """

    value: float = bananaproto.float_field(1)
    """The float value."""


@dataclass(eq=False, repr=False)
class Int64Value(bananaproto.Message):
    """
    Wrapper message for `int64`. The JSON representation for `Int64Value` is
    JSON string.
    """

    value: int = bananaproto.int64_field(1)
    """The int64 value."""


@dataclass(eq=False, repr=False)
class UInt64Value(bananaproto.Message):
    """
    Wrapper message for `uint64`. The JSON representation for `UInt64Value` is
    JSON string.
    """

    value: int = bananaproto.uint64_field(1)
    """The uint64 value."""


@dataclass(eq=False, repr=False)
class Int32Value(bananaproto.Message):
    """
    Wrapper message for `int32`. The JSON representation for `Int32Value` is
    JSON number.
    """

    value: int = bananaproto.int32_field(1)
    """The int32 value."""


@dataclass(eq=False, repr=False)
class UInt32Value(bananaproto.Message):
    """
    Wrapper message for `uint32`. The JSON representation for `UInt32Value` is
    JSON number.
    """

    value: int = bananaproto.uint32_field(1)
    """The uint32 value."""


@dataclass(eq=False, repr=False)
class BoolValue(bananaproto.Message):
    """
    Wrapper message for `bool`. The JSON representation for `BoolValue` is JSON
    `true` and `false`.
    """

    value: bool = bananaproto.bool_field(1)
    """The bool value."""


@dataclass(eq=False, repr=False)
class StringValue(bananaproto.Message):
    """
    Wrapper message for `string`. The JSON representation for `StringValue` is
    JSON string.
    """

    value: str = bananaproto.string_field(1)
    """The string value."""


@dataclass(eq=False, repr=False)
class BytesValue(bananaproto.Message):
    """
    Wrapper message for `bytes`. The JSON representation for `BytesValue` is
    JSON string.
    """

    value: bytes = bananaproto.bytes_field(1)
    """The bytes value."""
