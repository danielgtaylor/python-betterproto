...
class CodeGeneratorResponseFeature(bananaproto.Enum):
...
class Version(bananaproto.Message):
    """The version number of protocol compiler."""

    major: int = bananaproto.int32_field(1)
    minor: int = bananaproto.int32_field(2)
    patch: int = bananaproto.int32_field(3)
    suffix: str = bananaproto.string_field(4)
    """
...
@dataclass(eq=False, repr=False)
class CodeGeneratorRequest(bananaproto.Message):
    """An encoded CodeGeneratorRequest is written to the plugin's stdin."""

    file_to_generate: List[str] = bananaproto.string_field(1)
    """
    ...
    parameter: str = bananaproto.string_field(2)
    """The generator parameter passed on the command-line."""

    proto_file: List[
        "bananaproto_lib_google_protobuf.FileDescriptorProto"
    ] = bananaproto.message_field(15)
    """
    ...
    compiler_version: "Version" = bananaproto.message_field(3)
    """The version number of protocol compiler."""


@dataclass(eq=False, repr=False)
class CodeGeneratorResponse(bananaproto.Message):
    """The plugin writes an encoded CodeGeneratorResponse to stdout."""

    error: str = bananaproto.string_field(1)
    """
    ...
    supported_features: int = bananaproto.uint64_field(2)
    """
    A bitmask of supported features that the code generator supports. This is a
    bitwise "or" of values from the Feature enum.
    """

    file: List["CodeGeneratorResponseFile"] = bananaproto.message_field(15)


@dataclass(eq=False, repr=False)
class CodeGeneratorResponseFile(bananaproto.Message):
    ...
    insertion_point: str = bananaproto.string_field(2)
    """
    ...
    content: str = bananaproto.string_field(15)
    """The file contents."""

    generated_code_info: "bananaproto_lib_google_protobuf.GeneratedCodeInfo" = (
        bananaproto.message_field(16)
    )
    """
